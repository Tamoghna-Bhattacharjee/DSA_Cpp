...
// Calculate the inversion for each number in a permutation
// sol- Go from left to right and calc the no of element greater than the current element
//      and already visited. Mark the current element to be visited
//      visited -> 1 and non visited -> 0
