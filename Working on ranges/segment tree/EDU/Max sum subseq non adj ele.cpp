...
struct node {
    lli res[2][2]; 
    // res[L][R] => result of segment without leftmost ele iff L = 1 and 
    // right most ele if R = 1
    ...
    void merge(node &l, node &r) {
        // change
        res[0][0] = max({l.res[0][0] + r.res[0][0], l.res[0][1] + r.res[0][0], l.res[0][0] + r.res[1][0]});
        res[0][1] = max({l.res[0][0] + r.res[0][1], l.res[0][1] + r.res[0][1], l.res[0][0] + r.res[1][1]});
        res[1][0] = max({l.res[1][0] + r.res[0][0], l.res[1][1] + r.res[0][0], l.res[1][0] + r.res[1][0]});
        res[1][1] = max({l.res[1][0] + r.res[0][1], l.res[1][1] + r.res[0][1], l.res[1][0] + r.res[1][1]});        
    }
};
